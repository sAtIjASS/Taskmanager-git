...
class laptopclass extends StatelessWidget{
  List <Laptops> dataoflaptop = [];
  ...
  Future<List<Laptops>> getdata13() async {


    final response = await http.get(
        Uri.parse('https://ce04d0e5-4da8-4290-a53a-b993bec38876.mock.pstmn.io/laptop'));
    ...
    if (response.statusCode == 200) {
      ...
      for (Map<String, dynamic> index in save) {
        dataoflaptop.add(Laptops.fromJson(index));
      }

      return dataoflaptop; // Return the list of mobile objects
    } else {
      return dataoflaptop; // Return an empty list in case of an error
    }
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Brand Name :- ${snapshot.data![index].brandname}",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                         Text(" Processor :-${snapshot.data![index].configuration.processor}",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                        Text(" RAM :-${snapshot.data![index].configuration.ram}",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                         Text(" Storage :-${snapshot.data![index].configuration.storage}",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                        Text(" Display :-${snapshot.data![index].configuration.display}",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                        Text(" Graphics :-${snapshot.data![index].configuration.graphics}",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                        SizedBox(height: 20,),

                        InkWell(onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context){
                            return mobilesection(key:GlobalKey(),name:"${dataoflaptop[index].name}", image:dataoflaptop[index].image,description:dataoflaptop[index].description,price:dataoflaptop[index].price, brandname: dataoflaptop[index].brandname.toString(),setindexvalue:index );
                          }));
...
//
//     final laptops = laptopsFromJson(jsonString);
