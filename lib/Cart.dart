  ...
  Container nextButtonBar() {
    return Container(
      ...
      decoration: BoxDecoration(
          color: Colors.yellow.shade800, borderRadius: BorderRadius.circular(15)),
      child: Row(
        children: <Widget>[
          Text(
            "15-25 min",
...
class CustomAppBar extends StatelessWidget {
  final CartListBloc blocc = BlocProvider.getBloc<CartListBloc>();
...
class DragTargetWidget extends StatefulWidget {
  final CartListBloc blocs;

  DragTargetWidget(this.blocs);
  ...
  Widget build(BuildContext context) {
    ...
    return DragTarget<FoodItem>(
      onAccept: (FoodItem foodItem) {
        ...
        widget.blocs.removeFromList(currentFoodItem);
      },
