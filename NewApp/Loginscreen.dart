...
import '../Taskmanagementapp/auth.dart';
import 'NewAppmainsection.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          Image.network(
            'https://i.postimg.cc/c4pH4BNB/pixlr-image-generator-bf587b78-0627-4179-b16d-11e8d4d76d24.png',
            fit: BoxFit.cover,
          ),
          Container(
                        ...
                        if (_formKey.currentState!.validate()) {
                          try {
                            ...
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(builder: (context) => MyAppnewsapp()),
                            );
                          } catch (e) {
